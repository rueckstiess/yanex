...
"""
    ...
    def test_script_args_stored_in_metadata(self, per_test_experiments_dir, tmp_path):
...
"""
    ...
    def test_empty_script_args(self, per_test_experiments_dir, tmp_path):
...
"""
        ...
        result = self.runner.invoke(cli, ["run", str(script_path), "--ignore-dirty"])
