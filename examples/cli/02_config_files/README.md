...
After running:
- **View the config used**: `yanex show <id>` shows the stored parameters
- **Check stored params**: `~/.yanex/experiments/<id>/params.yaml` contains the full configuration
- **Compare experiments**: `yanex compare` shows parameter differences across experiments
...
- **Reproducibility**: Full configuration is saved with each experiment
